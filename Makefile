...
lint-py:  ## lint python with ruff
	python -m ruff check finance_flow
	python -m ruff format --check finance_flow
...
fix-py:  ## autoformat python code with ruff
	python -m ruff check --fix finance_flow
	python -m ruff format finance_flow
...
test:  ## run python tests
	python -m pytest -v finance_flow/tests

coverage:  ## run tests and collect test coverage
	python -m pytest -v finance_flow/tests --cov=finance_flow --cov-report term-missing --cov-report xml
